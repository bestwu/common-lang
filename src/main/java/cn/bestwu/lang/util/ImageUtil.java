...
public class ImageUtil {
   ...
   * @throws IOException IOException
   */
  public static boolean writeImage(RenderedImage im, String formatName, File file)
      throws IOException {
   ...
   * @throws IOException IOException
   */
  public static boolean writeImage(RenderedImage im, String formatName, OutputStream outputStream)
      throws IOException {
